  ...
  return (
    <div className="page h-screen flex flex-col justify-center max-sm:my-24">
      ...
      <div className="flex items-center gap-5 max-sm:flex-col max-sm:gap-8 ">
        <div className="flex flex-col gap-4 justify-center p-3 hover:bg-zinc-800 border border-zinc-900 w-[500px] max-sm:w-[310px] max-xsm:w-[280px] rounded-2xl transform transition-all duration-300">
          <Link href="https://kitchen-app-alpha.vercel.app/" target="_blank">
            <Image
              ...
              width={400}
              height={400}
              className="rounded-xl w-80 h-40 max-sm:w-80 max-sm:h-44 shadow-lg shadow-zinc-700"
            />
          </Link>
        ...
        <div className="flex flex-col gap-4 justify-center p-3 hover:bg-zinc-800 border border-zinc-900 w-[500px] max-sm:w-[310px] max-xsm:w-[280px] rounded-2xl transform transition-all duration-300">
          <Link href="https://ecommerce-ui-tau.vercel.app/" target="_blank">
            <Image
              src={FurniroImage}
              alt="kitchen app"
              width={450}
          ...
          <div>
            ...
            <p className="text-zinc-300 max-sm:text-sm">
              Furniro isimli Figma tasarımının Nextjs ve Tailwind CSS
              kullanılılarak yapımlış bir kopyası.
            </p>

            <Link
              href="https://github.com/devcebir/ecommerce-ui"
              target="_blank"
              className="flex items-center justify-center gap-3 mt-3 max-sm:text-sm text-zinc-400 hover:text-white border-zinc-400 rounded-md hover:border-white transform transition-all duration-300 border-b-2 w-36 max-sm:w-32"
            >
              <PiCodeBold />
